  ...
  <div class="app-container">
    ...
    <v-pageTable>
      ...
      >
        ...
        <el-table-column prop="phone" label="仓库" min-width="100"/>
        <el-table-column prop="landPhone" label="库位" min-width="100"/>
        ...
        <el-table-column prop="createTime" label="批次" min-width="90">
