  ...
  <div class="app-container">
    <v-pageSearch>
      <el-form :inline="true">
        ...
        <el-form-item label="产品批次：" label-width="70px">
          <el-input v-model="formSearch.employeeName" clearable placeholder="请输入"/>
        </el-form-item>
    ...
    <v-pageTable>
      ...
      >
        ...
        <el-table-column prop="createTime" label="产品批次" min-width="90">
          <template slot-scope="scope">{{ scope.row.createTime | parseTime('{y}-{m}-{d}') }}</template>
        </el-table-column>
        <el-table-column prop="mail" label="类型"/>
        <el-table-column prop="phone" label="数量"/>
        ...
        <el-table-column prop="employeeTypeName" label="原仓库"/>
        <el-table-column prop="employeeTypeName" label="原库位"/>
        <el-table-column prop="employeeTypeName" label="目标仓库"/>
        <el-table-column prop="employeeTypeName" label="目标库位"/>
