  ...
  <div class="app-container">
    <v-pageSearch>
      <el-form :inline="true">
        ...
        <el-form-item label="月份：" label-width="100px">
          <el-date-picker
    ...
    <v-pageTable>
      ...
      >
        <el-table-column prop="createTime" label="月份" min-width="90">
          <template slot-scope="scope">{{ scope.row.createTime | parseTime('{y}-{m}') }}</template>
        </el-table-column>
        ...
        <el-table-column prop="phone" label="期初数量"/>
        <el-table-column prop="deptName" label="入库数"/>
        <el-table-column prop="loginNum" label="期末数量"/>
        <el-table-column prop="employeeName" label="期初重量"/>
        <el-table-column prop="shipperName" label="入库重量"/>
        <el-table-column prop="employeeTypeName" label="出库重量"/>
        <el-table-column prop="employeeTypeName" label="期末重量"/>
        <el-table-column prop="employeeTypeName" label="周转期(天)"/>
        <el-table-column prop="employeeTypeName" label="出库次数"/>
        <el-table-column prop="employeeTypeName" label="周转率"/>
      </el-table>
